...
RUN ansible-playbook -i "[test] localhost," -c local tests/test_stop_mod.yml &&\
    ansible-playbook -i "[test] localhost," -c local tests/test_stop_mod.yml 2>/dev/null | grep -q 'changed=0.*failed=0' 2>/dev/null &&\
...
RUN ansible-playbook -i "[test] localhost," -c local tests/test_start_mod.yml &&\
    ansible-playbook -i "[test] localhost," -c local tests/test_start_mod.yml 2>/dev/null | grep -q 'changed=0.*failed=0' 2>/dev/null &&\
...
RUN ansible-playbook -i "[test] localhost," -c local tests/test_stop.yml &&\
    ansible-playbook -i "[test] localhost," -c local tests/test_stop.yml 2>/dev/null | grep -q 'changed=0.*failed=0' 2>/dev/null &&\
...
RUN ansible-playbook -i "[test] localhost," -c local tests/test_start.yml &&\
    ansible-playbook -i "[test] localhost," -c local tests/test_start.yml 2>/dev/null | grep -q 'changed=0.*failed=0' 2>/dev/null &&\
